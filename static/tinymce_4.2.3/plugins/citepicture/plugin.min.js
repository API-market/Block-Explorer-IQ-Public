tinymce.PluginManager.add('citepicture', function(editor, url) {
   ...
   editor.addButton('citepicture', {
      type: 'listbox',
      title: django.gettext('Media'),
      text: django.gettext('Media'),
      icon: 'image',
      values: getValues(),
      onclick: function() {
         //console.log(editor);
