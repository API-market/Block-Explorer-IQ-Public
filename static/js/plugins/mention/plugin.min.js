...
//            items = items.slice(0, this.opt
        ...
        insert: function (item, reusable_param, thisObject) {
            if (thisObject.options.delimiter == '@') {
                return "<span><a class='tooltippable' href=" + "'/wiki/" + item[thisObject.options.username] + "/' data-username='" + item[thisObject.options.username] + "' >" + item[thisObject.options.queryBy].trim() + "</a></span>&#8203;";
            }
